...
* **example of nearly sorted:** [2,1,4,3,6,5] in this array, **array is sorted** but **in pairs of two it is unsorted**
  here we can use the insertion sort for best results and **this is the reason it takes part in hybrid sorting
  algorithms like merge sort, quick sort and other algorithms.**
